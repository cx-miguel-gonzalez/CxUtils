...
Write-Debug "Replace Protected Branches API URL: $request_url"

$headers = GetRestHeadersForJsonRequest($session)
$body = ConvertTo-Json -InputObject $protectedBranches -Depth 10
Write-Debug $body

$response = Invoke-RestMethod -Method 'PUT' -Uri $request_url -Headers $headers -Body $body -ContentType 'application/json'
return $response
